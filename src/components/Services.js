        ...
        <div className="row mt-3">
          <div className="col-md-6 col-lg-4">
            <Service
              ...
              aciklama="specialise in Graphic design Whether you need to create a new
                  website or updat."
            />
          </div>
          ...
          <div className="col-md-6 col-lg-4">
            <Service
              ...
              baslik="Web Design"
              aciklama="design, build & maintain websites that keep pace with our
                  digital world."
            />
          </div>
          ...
          <div className="col-md-6 col-lg-4">
            <Service
              ...
              aciklama=" build mobile first solutions for ios, Android taking your idea
                  to polished product."
            />
          </div>
          ...
          <div className="col-md-6 col-lg-4">
            <Service
              ...
              aciklama="Music copying, writing, creat, transcription, arranging
          ...
          <div className="col-md-6 col-lg-4">
            <Service
              ...
              aciklama="Generate your sales opportunity with our best digital
                  marketing services."
            />
          </div>
          ...
          <div className="col-md-6 col-lg-4">
            <Service
              ...
              aciklama="I can manufacture magic that allows your brand to stand out
                  from the crowd."
            />
          </div>
        </div>
